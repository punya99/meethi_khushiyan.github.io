(function() {
    ...
    if ("undefined" != typeof WPD.dom && 1 < WPD.dom.version) return !1;
    WPD.dom = function() {
        if ("undefined" == typeof WPD.dom.fn || "undefined" == typeof WPD.dom.fn.a) WPD.dom.fn = {
            ...
            copy: function(a, b) {
                ...
                c = new a.constructor;
                for (d in a) a.hasOwnProperty(d) && (e = typeof a[d], c[d] = b && "object" === e && null !== a[d] ? this.copy(a[d]) :
                    a[d]);
                return c
            },
            parent: function(a) {
            ...
            prev: function(a) {
                ...
                if ("undefined" == typeof a) b.a = "undefined" != typeof b.a[0] &&
                    null != b.a[0].previousElementSibling ? [b.a[0].previousElementSibling] : [];
            ...
            on: function() {
                let a = arguments,
                    b = function(e, f) {
                        let g;
                        if ("mouseenter" == f.type || "mouseleave" == f.type || "hover" == f.type) {
                            var h = document.elementFromPoint(f.clientX, f.clientY);
                            if (!h.matches(e[1]))
                                for (;
                                    (h = h.parentElement) && !h.matches(e[1]););
                            null != h && (g = WPD.dom(h))
                        } else g = WPD.dom(f.target).closest(e[1]);
                        if (null != g && 0 < g.closest(this).length) {
                            h = [];
                            h.push(f);
                            if ("undefined" != typeof e[4])
                                for (f = 4; f < e.length; f++) h.push(e[f]);
                            e[2].apply(g.get(0), h)
                        }
                    },
                    c = function(e, f) {
                        let g = [];
                        g.push(f);
                        if ("undefined" != typeof e[3])
                            for (f = 3; f < e.length; f++) g.push(e[f]);
                        e[1].apply(this, g)
                    },
                    d = a[0].split(" ");
                for (let e = 0; e < d.length; e++) {
                    let f = d[e];
                    "string" == typeof a[1] ? this.forEach(function(g) {
                        if (!WPD.dom._fn.hasEventListener(g, f, a[2])) {
                            let h = b.bind(g, a);
                            g.addEventListener(f, h, a[3]);
                            g._wpd_el = "undefined" == typeof g._wpd_el ? [] : g._wpd_el;
                            g._wpd_el.push({
                                type: f,
                                selector: a[1],
                                func: h,
                        ...
                        if (!WPD.dom._fn.hasEventListener(g, f, a[1])) {
                            let h = c.bind(g, a);
                            g.addEventListener(f, h, a[2]);
                            g._wpd_el = "undefined" == typeof g._wpd_el ? [] : g._wpd_el;
                            g._wpd_el.push({
                                type: f,
                                func: h,
                        ...
                        if ("undefined" === typeof a) {
                            ...
                            if ("undefined" == typeof b) {
                                ...
                                c._wpd_el.forEach(function(f) {
                                    f.type == d && f.trigger == b ? c.removeEventListener(d,
                                        f.func, f.args) : e.push(f)
                                });
                                c._wpd_el = e
                            }
                        })
            ...
            trigger: function(a, b, c, d) {
                ...
                this.forEach(function(e) {
                    var f = !1;
                    d && "undefined" != typeof jQuery && "undefined" != typeof jQuery._data && "undefined" != typeof jQuery._data(e, "events") && "undefined" != typeof jQuery._data(e, "events")[a] && (jQuery(e).trigger(a, b), f = !0);
                        ...
                        for (;;) {
                            ...
                            "undefined" != typeof h._wpd_el && h._wpd_el.forEach(function(k) {
                                if ("undefined" !== typeof k.selector) {
                                    ...
                                    0 < m.length && 0 <= m.get().indexOf(e) && k.type == a && (m = new Event(a), k.trigger.apply(e, [m].concat(b)), g = !0)
                                }
                            });
                            if (g) break
                        }
            ...
            bodyTransformY: function() {
                if ("undefined" !== typeof WebKitCSSMatrix) {
                    ...
                    if ("undefined" != typeof a.transform && (a = new WebKitCSSMatrix(a.transform), "undefined" != a.m42)) return a.m42
                }
                return 0
            },
    ...
    WPD.dom.fn.animate = function(a, b, c) {
        ...
        this.forEach(function(e) {
            ...
            !1 === a ? n.forEach(function(l) {
                clearInterval(l)
            }) : (q = "undefined" != typeof d._animate.easing[c] ? d._animate.easing[c] : d._animate.easing.easeInOutQuad, Object.keys(a).forEach(function(l) {
                -1 <
                    l.indexOf("scroll") ? k[l] = e[l] : k[l] = parseInt(window.getComputedStyle(e)[l]);
                m[l] = a[l] - k[l]
...
(function() {
    ...
    WPD.dom.fn.highlight = function(b, c) {
        function d(g, h, k, m, n) {
            n = "" == n ? ".exhghttt" : n;
            if (3 === g.nodeType) {
                if (h = g.data.normalize("NFD").replace(/[\u0300-\u036f]/g, "").match(h)) return k = document.createElement(k || "span"), k.className = m || "highlight", m = /\.|,|\s/.test(h[0].charAt(0)) ?
                    h.index + 1 : h.index, g = g.splitText(m), g.splitText(h[1].length), m = g.cloneNode(!0), k.appendChild(m), g.parentNode.replaceChild(k, g), 1
        ...
        b.forEach(function(g, h, k) {
            k[h].replace(/[-[\]{}()*+?.,\\^$|#\s]/g, "\\$&").normalize("NFD").replace(/[\u0300-\u036f]/g, "")
        });
...
(function() {
    WPD.dom.fn.inViewPort = function(a, b) {
        ...
        return 0 >= h || g >= e ?
            !1 : 0 < a ? c >= a && f < d - a : (0 < f && c <= d - a) | (0 >= c && f > a)
    };
